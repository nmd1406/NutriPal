...
class HealthIndicatorScreen extends StatefulWidget {
  const HealthIndicatorScreen({super.key});

  @override
  State<HealthIndicatorScreen> createState() => _HealthIndicatorScreenState();
}

class _HealthIndicatorScreenState extends State<HealthIndicatorScreen>
